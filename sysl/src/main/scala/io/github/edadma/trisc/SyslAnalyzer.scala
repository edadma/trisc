...
class SyslAnalyzer(val contractsEnabled: Boolean = true) extends SyslAnalyzerContracts, SyslAnalyzerPostPasses, SyslAnalyzerStatements, SyslAnalyzerTypes, SyslAnalyzerGenerics, SyslAnalyzerExpressions:
