...
class SyslAnalyzer(val contractsEnabled: Boolean = true) extends SyslAnalyzerContracts, SyslAnalyzerPostPasses, SyslAnalyzerStatements, SyslAnalyzerTypes, SyslAnalyzerUnification, SyslAnalyzerGenerics, SyslAnalyzerExtensions, SyslAnalyzerExpressions:
