...
object SyslStdlib:
  ...
  private lazy val ioMeta: ModuleMeta =
    new ModuleMeta(List(
      ...
      // Methods
      SymbolMeta("ByteReader_read", SymbolMeta.Kind.Func(List(PtrType(SyslType.StructType("ByteReader", List(("data", SliceType(U8)), ("pos", I32)))), SliceType(U8)), I32), isPrivate = false),
    ))
