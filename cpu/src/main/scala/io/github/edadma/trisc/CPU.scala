  ...
  def buildInstructionTable(): Unit =
    populate(
      List[(String, Map[Char, Int] => Instruction)](
        ...
        "111 000 rrr 0010000; r:1-7" -> ((operands: Map[Char, Int]) => new PSHR(operands('r'))),
        "111 000 rrr 0010001; r:1-7" -> ((operands: Map[Char, Int]) => new POPR(operands('r'))),
