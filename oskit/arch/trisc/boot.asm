...
trap_handler
  ...
  pshd r4                      ; save handler pointer
  pshd r2                      ; save arg1
  pshd r3                      ; save arg2
  ; r1 still has syscall number
  extern oskit_kernel__syscall_check_allowed
  movi r4, oskit_kernel__syscall_check_allowed
  jalr r6, r4                  ; r1 = 1 if allowed, 0 if denied
  popd r3                      ; restore arg2
  popd r2                      ; restore arg1
